...
const mess = "1"
export const Navbar = (props,onSwitch,isEnabled)=>{
    ...
    return(
        <View style={styles.navbar}>
                     <Modal visible={modalOpen} anismationType={'slide'}>
                        <View>
                          <Icon style={styles.Cross} name="times" size={25} color="black" onPress={()=> setModalOpen(false)} />
      ...
      />
            ...
            <View style={styles.logo}>
                <Icon style={styles.todoIcon} name="th-list" size={30} color="black"/>
                <Text style={styles.text}>{props.title}</Text>
            </View>
            <View style={styles.infoBlock}>
                <TouchableOpacity>
                      <Icon style={styles.explanation} name="exclamation-circle" size={25} color="black" onPress={()=> setModalOpen(true)} />
            </TouchableOpacity>
            </View>
    </View>
    )
